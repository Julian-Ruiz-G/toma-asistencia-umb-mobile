...
export const VALIDATE_REGISTER_PHOTO_URL = API_BASE ? `${API_BASE}/validate-register-photo` : '';
export const CAPTCHA_CHALLENGE_URL = API_BASE ? `${API_BASE}/captcha-challenge` : '';
export const CAPTCHA_VERIFY_URL = API_BASE ? `${API_BASE}/captcha-verify` : '';
...
export const MARK_NOTIFICATIONS_READ_URL = API_BASE ? `${API_BASE}/mark-notifications-read` : '';
export const STUDENT_ATTENDANCE_HISTORY_URL = API_BASE ? `${API_BASE}/student-attendance-history` : '';
export const SET_ATTENDANCE_STATUS_URL = API_BASE ? `${API_BASE}/set-attendance-status` : '';
