...
export default function LiveAttendanceDashboard({ navigation, route }) {
  ...
  const filteredStudents = useMemo(() => {
    return dataSource.filter((student) => {
      ...
      const matchesFilter =
        filter === 'all' ||
        (filter === 'present' && student.status === 'asistencia') ||
        (filter === 'late' && student.status === 'retardo') ||
        (filter === 'absent' && student.status === 'inasistencia');
    ...
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.body}>
        ...
        <Text style={styles.hoursHint}>
          Puedes cambiar Presente / Retardo / Ausente solo durante el horario de clase (desde 15 min antes hasta la hora de fin).
        </Text>
            ...
            <View key={student.id} style={[styles.studentCard, { borderColor: cfg.border }]}>
              ...
              <View style={styles.statusBtns}>
                <Pressable
                  ...
                  onPress={() => updateStatus(student.id, 'asistencia')}
                  style={[
                    styles.statusBtn,
                ...
                >
                  ...
                  <Text
                    style={[
                      ...
                      student.status === 'asistencia' ? styles.statusBtnTextOn : null,
                    ]}
                  >
                    Presente
                  </Text>
                ...
                <Pressable
                  disabled={!!savingStatus}
                  onPress={() => updateStatus(student.id, 'retardo')}
                  style={[
                    styles.statusBtn,
                ...
                >
                  ...
                  <Text
                    style={[
                      styles.statusBtnText,
                      student.status === 'retardo' ? styles.statusBtnTextOn : null,
                    ]}
                  >
                    Retardo
                  </Text>
                ...
                <Pressable
                  disabled={!!savingStatus}
                  onPress={() => updateStatus(student.id, 'inasistencia')}
                  style={[
                    styles.statusBtn,
                ...
                >
                  ...
                  <Text
                    style={[
                      styles.statusBtnText,
                      student.status === 'inasistencia' ? styles.statusBtnTextOn : null,
                    ]}
                  >
                    Ausente
                  </Text>
